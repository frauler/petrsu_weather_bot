...
class WindDirection(IntEnum):
    """Класс с основными направлениями ветра"""
    Север = 0
    Северо_восток = 45
    Восток = 90
    Юго_восток = 135
...
def get_weather(longitude, latitude) -> Weather:
    """Запрашивает погоду у OpenWeather API и возвращает её"""
...
def _parse_wind_direction(openweather_dict: dict) -> str:
    ...
    raw_dir = WindDirection(degrees).name
    new_dir = raw_dir.replace("_", "-")
    return new_dir